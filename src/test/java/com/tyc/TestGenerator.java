...
public class TestGenerator {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("tyc")
                .setOutputDir("E:\\IDEA_workspace\\family_service_platform\\src\\main\\java")//设置输出路径
        ...
        packageConfig.setParent("com.tyc").setMapper("mapper")
